...
public class VncView extends AppCompatImageView {
    ...
    private IConnectionInfo connectionInfoCallback;

    /**
	 * Constructor used by the inflation apparatus
	 * @param context
	 */
//	public VncView(final Context context, AttributeSet attrs)
	public VncView(final Context context, AttributeSet attrs)
	{
		super(context, attrs);
...
//        setDrawingCacheEnabled(true);
	 ...
	 */
	public void initializeVncCanvas(ConnectionBean bean, final Runnable setModes) {
		connection = bean;
...
//					else
	...
	private Runnable reDraw = new Runnable() {
		public void run() {
			...
			if (bitmapData != null)
				bitmapData.updateView(VncView.this);
		}
	};
    ...
    public void setConnectionInfoCallback(IConnectionInfo callback) {
	...
	public void showConnectionInfo() {
        ...
        if (connectionInfoCallback != null) {
            connectionInfoCallback.show(msg);
        }
